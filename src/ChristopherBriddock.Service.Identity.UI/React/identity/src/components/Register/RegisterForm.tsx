      ...
      <div className="flex justify-center items-center h-screen bg-gray-100">
        <div className="flex rounded-lg shadow-lg overflow-hidden">
          <div className="bg-black text-white px-12 py-16 flex flex-col justify-center">
            ...
            <p className="text-gray-300">Use the form to create a new account.</p>
          </div>
          <div className="bg-white px-12 py-16">
            <h2 className="text-2xl font-bold mb-4">Register a new account</h2>
            <p className="text-gray-500 mb-6">Already have an account? <a href="#" className="text-blue-500">Log in</a></p>
            <div className="mb-4">
            ...
            <div className="mb-4">
              <input
                className="w-full px-4 py-2 border border-gray-400 rounded-lg shadow-sm mb-2"
                type="email"
                placeholder="Email"
                value={email}
            ...
            <button
              type="submit"
              className="w-full bg-black text-white font-semibold py-2 px-4 rounded-lg shadow-sm"
            >
              Register
            </button>
          </div>
