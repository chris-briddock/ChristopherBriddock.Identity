...
dotnet user-secrets set "ConnectionStrings:Default" "Host=172.16.1.8;Port=5432;Username=pguser;Password=drRhxp397NP4__;Database=ChristopherBriddock.Identity;"
