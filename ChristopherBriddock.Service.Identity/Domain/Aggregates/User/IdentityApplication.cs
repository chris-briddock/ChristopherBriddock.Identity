...
/// </summary>
public class IdentityApplication : IdentityApplication<Guid>, IAuditableEntity, ISoftDeletable
{
    /// <inheritdoc/>
    [Key]
    ...
    public ICollection<ApplicationUserApplication> UserApplications { get; set; } = new List<ApplicationUserApplication>();
}
